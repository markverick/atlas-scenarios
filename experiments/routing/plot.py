...
Usage:
    python3 experiments/routing/plot.py
    python3 experiments/routing/plot.py --emu results/emu_routing/scalability.csv \
...
from experiments.scalability.plot import aggregate, load_csv
