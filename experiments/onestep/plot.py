...
Overlaid emu vs sim mode:
    python3 experiments/onestep/plot.py --sim-csv results/sim_onestep/comparison.csv \
                                                                            --emu-csv results/emu_onestep/comparison.csv

Single-source mode:
    python3 experiments/onestep/plot.py --csv results/sim_onestep/comparison.csv
"""
